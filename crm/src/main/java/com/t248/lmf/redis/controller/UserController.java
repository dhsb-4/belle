...
//        model.addAttribute("roles",roles);
    ...
    public String findRole(@RequestParam(required = false,defaultValue = "0") Long userId,
                            @RequestParam(required = false,defaultValue = "1") int pageIndex,
        ...
        Page<Role> userPager = roleService.findPageByMap(userId,usrName,pageable);
        model.addAttribute("userPager",userPager);
        return "role/list";
    }
}
